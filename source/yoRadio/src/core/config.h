...
class Config {
  ...
  public:
    ...
    void saveVolume();
    /*  Запис у флеш відкладається і склеюється: сто змін поспіль дають один
        запис, а не сто. Ресурс пам'яті скінченний, і берегти його треба саме
        від сплесків — пролистування станцій, ведення повзунка тощо.  */
