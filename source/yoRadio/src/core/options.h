...
#endif
#ifndef I2S_MCLK
  #define I2S_MCLK      255 // MCLK - master clock, needed by codecs like ES8311
#endif

/*        ES8311 CODEC            */
#ifndef I2S_ES8311
  #define I2S_ES8311    false // true - configure the ES8311 codec over I2C
#endif
#ifndef ES8311_ADDR
  #define ES8311_ADDR   0x18  // 0x18 - CE pin low, 0x19 - CE pin high
#endif
#ifndef ES8311_VOLUME
  #define ES8311_VOLUME 75    // codec DAC volume, 75 == 0 dB
#endif
...
#endif
#ifndef SD_SDMMC
  #define SD_SDMMC      false  // true - SD card on the SDIO bus instead of SPI
#endif
#if SD_SDMMC
  /*  SDC_CS is meaningless on the SDIO bus, but the rest of yoRadio uses
      "SDC_CS!=255" as the "there is an SD card" flag, so keep it != 255.  */
  #undef  SDC_CS
  #define SDC_CS        254
  #ifndef SDMMC_CLK
    #define SDMMC_CLK   38
...
#endif
#ifndef DSP_INVERT_BASE
  /*  Некоторым панелям (IPS ILI9341V) инверсия нужна включённой, иначе
      картинка идёт негативом. Этот флаг задаёт исходное состояние, а
      переключатель "invert display" в веб-интерфейсе работает от него.  */
  #define DSP_INVERT_BASE   false
#endif
#ifndef EXT_WEATHER
