...
//If core is not defined, then we are running in Arduino or PIO
  ...
  /*  Задача веб-сервера стояла на 3 — нижче за малювання екрана (4) і звук
      AirPlay (5) на тому самому ядрі 0. Поки екран перемальовується (а це
      близько чверті часу ядра), відповідь програмі чекає: кнопки гучності й
      вибору треку спрацьовували із затримкою, а короткі запити пошуку радіо
      взагалі не встигали в строк. Роботи тут мало й вона уривчаста, тож
      ставимо над малюванням, але нижче за mDNS (6) і сторожа (10).  */
  #define XTASK_PRIOTITY  3   /* дослід: повертаю, щоб перевірити падіння на паузі */
#endif
