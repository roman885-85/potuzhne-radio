...
Мережу можна вибрати й на самому радіо: **☰ → параметри → Wi-Fi** — список знайдених мереж гортається пальцем,
як список станцій. Радіо пам'ятає до п'яти мереж; у кінці списку — **«відомі мережі»**, де мережу можна підняти
першою або забути.
